describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  beforeEach(() => {
    ...
    it.only('refazendo parando e avançando o relógio do navegador - exibe mensagem de erro quando o telefone se torna obrigatório mas não é preenchido antes do envio do formulário', function() {
      const longText = 'Olá! Tudo bem? Estou com dificuldades para acessar o módulo X. Meu número de matrícula no curso é X0X0000XX. Poderiam me auxiliar, por favor? Muito obrigada!'
